...
## 4. Bounded Distribution Experiment

To test this inference against reality, the First Contact outreach is constrained to the following experimental parameters:

```text
Ask:
  One under-10-minute cold run against the published package.

Placements:
  1 formal-methods/high-assurance cluster
  1 agent-governance/tool-permission cluster

Canonical destination:
  https://github.com/XRastlinX/logos-formal/issues/2

Observation window:
  14 days

Primary outcome:
  At least one qualifying independent Issue #2 report.

Secondary observations:
  Time to first report
  Report completeness
  Reproducible friction
  Misunderstanding of interpretation/authorization/effect

Non-outcomes:
  Views, likes, stars, praise, and internal runs do not count.
```

## 5. Standard Public Pointer
